...
class Collect(Node):
    def __init__(self):
        ...
        ts = message_filters.ApproximateTimeSynchronizer([sub_center_camera, sub_control], 1, 0.1)
    ...
    def callback(self, center_camera, control):
...
def main(args=None):
    rospy.init_node('turtlebot3_collect')
    collect = Collect()
